...
#include <linux/of.h>
#include "gsp_interface_qogirn6l.h"
#include "../gsp_debug.h"
				  ...
				  struct device_node *node)
{
	...
	struct gsp_interface_qogirn6l *gsp_interface = NULL;

	gsp_interface = (struct gsp_interface_qogirn6l *)intf;

	gsp_interface->clk_dpu_vsp_eb = of_clk_get_by_name(node,
		QOGIRN6L_DPU_VSP_EB_NAME);
