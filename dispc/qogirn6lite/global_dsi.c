...
const struct dsi_glb_ops qogirn6lite_dsi_glb_ops = {
...
const struct dsi_glb_ops qogirn6lite_s_dsi_glb_ops = {
...
MODULE_DESCRIPTION("sprd qogirn6lite dsi global APB regs low-level config");
