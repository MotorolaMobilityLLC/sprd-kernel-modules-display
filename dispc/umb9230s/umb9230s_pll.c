...
static void umb9230s_reg_write(struct dphy_tx_context *ctx, uint16_t reg, uint8_t val)
{
    u32 buf[2] = {};
...
static int dphy_calc_hop_param(struct dphy_pll *pll, int i)
{
	u8 delta;
...
static int dphy_calc_pll_param(struct dphy_pll *pll)
{
	...
	if (pll->hop_en)
		return dphy_calc_hop_param(pll, i);
...
FAIL:
	...
	pr_err("umb9230s failed to calculate dphy pll parameters\n");

	return -1;
}

static int dphy_set_pll_reg(struct dphy_tx_context *ctx, struct dphy_pll *pll)
{
	if (!pll || !pll->fvco)
		goto FAIL;
	...
	umb9230s_reg_write(ctx, 0x03, regs._03.val);
	umb9230s_reg_write(ctx, 0x04, regs._04.val);
	umb9230s_reg_write(ctx, 0x07, regs._07.val);
	umb9230s_reg_write(ctx, 0x08, regs._08.val);
	umb9230s_reg_write(ctx, 0x09, regs._09.val);
	umb9230s_reg_write(ctx, 0x0a, regs._0a.val);
	umb9230s_reg_write(ctx, 0x0b, regs._0b.val);
	umb9230s_reg_write(ctx, 0x0c, regs._0c.val);
	umb9230s_reg_write(ctx, 0x0d, regs._0d.val);
	umb9230s_reg_write(ctx, 0x0e, regs._0e.val);
	umb9230s_reg_write(ctx, 0x0f, regs._0f.val);
	umb9230s_reg_write(ctx, 0x06, regs._06.val);
	return 0;

FAIL:
	pr_err("umb9230s failed to set dphy pll registers\n");

	return -1;
}

static int dphy_pll_config(struct dphy_tx_context *ctx)
{
	int ret;
...
FAIL:
	pr_err("umb9230s failed to config dphy pll\n");

	return -1;
}

static int umb9230s_dphy_set_timing_regs(struct dphy_tx_context *ctx, int type, u8 val[])
{
	switch (type) {
	case REQUEST_TIME:
		umb9230s_reg_write(ctx, 0x31, val[CLK]);
		umb9230s_reg_write(ctx, 0x41, val[DATA]);
		umb9230s_reg_write(ctx, 0x51, val[DATA]);
		umb9230s_reg_write(ctx, 0x61, val[DATA]);
		umb9230s_reg_write(ctx, 0x71, val[DATA]);

		umb9230s_reg_write(ctx, 0x90, val[CLK]);
		umb9230s_reg_write(ctx, 0xa0, val[DATA]);
		umb9230s_reg_write(ctx, 0xb0, val[DATA]);
		umb9230s_reg_write(ctx, 0xc0, val[DATA]);
		umb9230s_reg_write(ctx, 0xd0, val[DATA]);
		break;
	case PREPARE_TIME:
		umb9230s_reg_write(ctx, 0x32, val[CLK]);
		umb9230s_reg_write(ctx, 0x42, val[DATA]);
		umb9230s_reg_write(ctx, 0x52, val[DATA]);
		umb9230s_reg_write(ctx, 0x62, val[DATA]);
		umb9230s_reg_write(ctx, 0x72, val[DATA]);

		umb9230s_reg_write(ctx, 0x91, val[CLK]);
		umb9230s_reg_write(ctx, 0xa1, val[DATA]);
		umb9230s_reg_write(ctx, 0xb1, val[DATA]);
		umb9230s_reg_write(ctx, 0xc1, val[DATA]);
		umb9230s_reg_write(ctx, 0xd1, val[DATA]);
		break;
	case ZERO_TIME:
		umb9230s_reg_write(ctx, 0x33, val[CLK]);
		umb9230s_reg_write(ctx, 0x43, val[DATA]);
		umb9230s_reg_write(ctx, 0x53, val[DATA]);
		umb9230s_reg_write(ctx, 0x63, val[DATA]);
		umb9230s_reg_write(ctx, 0x73, val[DATA]);

		umb9230s_reg_write(ctx, 0x92, val[CLK]);
		umb9230s_reg_write(ctx, 0xa2, val[DATA]);
		umb9230s_reg_write(ctx, 0xb2, val[DATA]);
		umb9230s_reg_write(ctx, 0xc2, val[DATA]);
		umb9230s_reg_write(ctx, 0xd2, val[DATA]);
		break;
	case TRAIL_TIME:
		umb9230s_reg_write(ctx, 0x34, val[CLK]);
		umb9230s_reg_write(ctx, 0x44, val[DATA]);
		umb9230s_reg_write(ctx, 0x54, val[DATA]);
		umb9230s_reg_write(ctx, 0x64, val[DATA]);
		umb9230s_reg_write(ctx, 0x74, val[DATA]);

		umb9230s_reg_write(ctx, 0x93, val[CLK]);
		umb9230s_reg_write(ctx, 0xa3, val[DATA]);
		umb9230s_reg_write(ctx, 0xb3, val[DATA]);
		umb9230s_reg_write(ctx, 0xc3, val[DATA]);
		umb9230s_reg_write(ctx, 0xd3, val[DATA]);
		break;
	case EXIT_TIME:
		umb9230s_reg_write(ctx, 0x36, val[CLK]);
		umb9230s_reg_write(ctx, 0x46, val[DATA]);
		umb9230s_reg_write(ctx, 0x56, val[DATA]);
		umb9230s_reg_write(ctx, 0x66, val[DATA]);
		umb9230s_reg_write(ctx, 0x76, val[DATA]);

		umb9230s_reg_write(ctx, 0x95, val[CLK]);
		umb9230s_reg_write(ctx, 0xA5, val[DATA]);
		umb9230s_reg_write(ctx, 0xB5, val[DATA]);
		umb9230s_reg_write(ctx, 0xc5, val[DATA]);
		umb9230s_reg_write(ctx, 0xd5, val[DATA]);
		break;
	case CLKPOST_TIME:
		umb9230s_reg_write(ctx, 0x35, val[CLK]);
		umb9230s_reg_write(ctx, 0x94, val[CLK]);
		break;
...
static int dphy_timing_config(struct dphy_tx_context *ctx)
{
	u8 val[2];
	u32 tmp = 0;
	...
	*/
	...
	val[DATA] = val[CLK];
	umb9230s_dphy_set_timing_regs(ctx, REQUEST_TIME, val);
	...
	val[DATA] = DIV_ROUND_UP(AVERAGE(range[L], range[H]),
			t_half_byteck) - 1;
	umb9230s_dphy_set_timing_regs(ctx, PREPARE_TIME, val);
	...
	val[DATA] = DIV_ROUND_UP(range[L] * factor
			...
			t_byteck) - 2;
	umb9230s_dphy_set_timing_regs(ctx, ZERO_TIME, val);
	...
	umb9230s_dphy_set_timing_regs(ctx, TRAIL_TIME, val);
	...
	val[DATA] = val[CLK];
	umb9230s_dphy_set_timing_regs(ctx, EXIT_TIME, val);
	...
	val[CLK] = DIV_ROUND_UP(range[L] * factor, t_byteck) - 2;
	val[DATA] = val[CLK];
	umb9230s_dphy_set_timing_regs(ctx, CLKPOST_TIME, val);
...
static int dphy_hop_start(struct dphy_tx_context *ctx)
{
	/* start hopping */
	...
	pr_info("umb9230s start hopping\n");
	return 0;
}

static int dphy_hop_stop(struct dphy_tx_context *ctx)
{
	regs._03.bits.freq_hopping = 0;
	umb9230s_reg_write(ctx, 0x3, regs._03.val);
	pr_info("umb9230s stop hopping\n");
	return 0;
}

static int dphy_hop_config(struct dphy_tx_context *ctx, int delta, int period)
{
	dphy_hop_stop(ctx);
...
static int dphy_ssc_start(struct dphy_tx_context *ctx)
{
	pll.mod_en = true;
	pll.hop_en = false;
...
static int dphy_ssc_stop(struct dphy_tx_context *ctx)
{
	pll.mod_en = false;
	regs._06.bits.mod_en = false;
	umb9230s_reg_write(ctx, 0x6, regs._06.val);

	return 0;
}

static int dphy_ssc_en(struct dphy_tx_context *ctx, bool en)
{
	if (en) {
		pr_info("umb9230s ssc enable\n");
		dphy_ssc_start(ctx);
	} else {
		dphy_ssc_stop(ctx);
		pr_info("umb9230s ssc disable\n");
	}
 ...
 */
static void dphy_force_pll(struct dphy_tx_context *ctx, int force)
{
	u8 data;
	...
	umb9230s_reg_write(ctx, 0xe, data);
}

const struct dphy_tx_pll_ops umb9230s_dphy_tx_pll_ops = {
